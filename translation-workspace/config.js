...
const config = {
  ...
  databaseUrl: process.env.POSTGRES_URL || 'postgresql://neondb_owner:npg_V23PZNsmwgOy@ep-billowing-dust-a2e8u1w2-pooler.eu-central-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require',
